package codinghigh.interviews.companies.amazon.oa;
...
public class CommonManager {
    ...
    public void test() {
        ...
        Employee res = findCommonManager(list.get(0), list.get(11), list.get(8));
        System.out.println(res);
        res = closestCommonManager(list.get(0), list.get(11), list.get(8));
        System.out.println(res);
    }
